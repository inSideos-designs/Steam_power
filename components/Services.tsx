    ...
    () =>
      SERVICES.filter(
        (service) =>
          ...
          // If Indoor, show all services. Otherwise filter by focus.
          (selectedCategory === 'indoor' ? true : service.serviceType === selectedFocus),
      ),
    ...
    <section id="services" className="py-24 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 space-y-10">
              ...
              {CATEGORY_ORDER.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left rounded-2xl border transition-all p-5 h-full ${isActive
          ...
          {/* Step 2: Focus Area - Hidden for Indoor */}
