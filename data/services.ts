...
export const SERVICES: Service[] = [
  // Indoor – Carpet Cleaning
  {
    id: 'carpet-cleaning',
    title: 'Carpet Cleaning',
    description: 'Professional steam extraction that removes embedded soil, allergens, and odors. Includes spot treatment, pretreating traffic lanes, and complimentary deodorizer and protection. Custom pricing at $0.30 per square foot.',
  ...
  },
  {
    ...
    priceCents: 5000,
    durationMinutes: 45,
    imageUrl: '/services/new-pictures/small-room-carpet.jpg',
    category: 'indoor',
    serviceType: 'carpet',
  },
  ...
  // Indoor – Area Rug Cleaning
  {
    ...
    description: 'Convenient maintenance cleaning performed in your home for area rugs that need a freshen up. Custom pricing based on rug dimensions at $0.75 per square foot.',
    price: 'Starting at $60.00',
    priceCents: 6000,
    durationMinutes: 60,
    imageUrl: '/services/new-pictures/Area Rug Cleaning.PNG',
    category: 'indoor',
  ...
  },
  {
    ...
    description: 'Our deepest clean: we pick up, treat both sides, neutralize odors, and return your rug looking new. Custom pricing based on rug dimensions at $3.00 per square foot. Maximum size 12\' × 12\'.',
    price: 'Starting at $192.00',
    priceCents: 19200,
    durationMinutes: 0,
    imageUrl: '/services/new-pictures/Area Rug Deep Cleaning (Offsite).jpg',
    category: 'indoor',
    serviceType: 'area_rug',
  },
  ...
  // Indoor – Tile & Grout Cleaning
  {
    ...
    description: 'Professional tile and grout cleaning with steam agitation and extraction. Removes residue, restores sheen, and penetrates grout lines for a deep clean. Custom pricing at $0.40 per square foot.',
  ...
  // Indoor – Upholstery Cleaning
  {
    ...
    description: 'Single armchair or accent chair cleaned with fabric-safe solution and quick dry finish. Complimentary deodorizer and protection included.',
    price: '$45.00',
    priceCents: 4500,
    durationMinutes: 35,
  ...
  },
  {
    ...
    description: 'Complete two-seat refresh targeting armrests, cushions, and high-touch zones. Complimentary deodorizer and protection included.',
    price: '$70.00',
    priceCents: 7000,
    durationMinutes: 55,
  ...
  },
  {
    id: 'upholstery-sofa',
    title: 'Sofa Cleaning',
    description: 'Three-seat sofa cleaning with fiber grooming for even texture. Complimentary deodorizer and protection included.',
    price: '$95.00',
    priceCents: 9500,
    durationMinutes: 70,
  ...
  },
  {
    ...
    description: 'Refreshes a two-piece sectional with focus on corners and lounge sections. Complimentary deodorizer and protection included.',
    price: '$125.00',
    priceCents: 12500,
    durationMinutes: 90,
  ...
  },
  {
    ...
    description: 'Cleans expansive multi-piece sectionals, removing spills and restoring brightness. Complimentary deodorizer and protection included.',
    price: '$180.00',
    priceCents: 18000,
    durationMinutes: 130,
  ...
  },
  {
    ...
    description: 'Finishing touch that tackles footstools and ottomans to match refreshed seating. Complimentary deodorizer and protection included.',
    price: '$15.00',
    priceCents: 1500,
    durationMinutes: 25,
    imageUrl: '/services/new-pictures/ottoman-cleaning.jpg',
    category: 'indoor',
    serviceType: 'upholstery',
  },
  {
    ...
    description: 'Per-chair pricing for dining sets. Combine quantities for bundled tables and seating. Complimentary deodorizer and protection included.',
    price: '$15.00',
    priceCents: 1500,
    durationMinutes: 15,
  ...
  // Indoor – Window Cleaning
  {
    ...
    description: 'Crystal-clear window cleaning with detail work on frames, tracks, and seals. Price per window based on size at $1.00 per square foot. Includes streak-free finish.',
  ...
  // Outdoor – Power Washing & Exterior Services
  {
    ...
    priceCents: null,
    durationMinutes: 180,
    imageUrl: '/services/new-pictures/house-wash-exterior.jpg',
    category: 'outdoor',
  ...
  },
  {
    ...
    priceCents: 12000,
    durationMinutes: 120,
    imageUrl: '/services/new-pictures/garage-floor-cleaning.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  {
    ...
    priceCents: null,
    durationMinutes: 120,
    imageUrl: '/services/new-pictures/Fence Washing.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  {
    ...
    priceCents: 10000,
    durationMinutes: 150,
    imageUrl: '/services/new-pictures/deck-patio-new.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  {
    ...
    priceCents: 4000,
    durationMinutes: 60,
    imageUrl: '/services/new-pictures/outdoor-furniture-new.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  {
    ...
    priceCents: 7500,
    durationMinutes: 90,
    imageUrl: '/services/new-pictures/playset-cleaning-new.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  {
    ...
    priceCents: 5000,
    durationMinutes: 45,
    imageUrl: '/services/new-pictures/outdoor-decor-new.jpg',
    category: 'outdoor',
    serviceType: 'powerwash',
  },
  ...
  // Outdoor – Roofing & Gutters
  {
    ...
    priceCents: null,
    durationMinutes: 180,
    imageUrl: '/services/new-pictures/roof-cleaning-new.jpg',
    category: 'outdoor',
    serviceType: 'roofing',
  },
  {
    ...
    priceCents: null,
    durationMinutes: 120,
    imageUrl: '/services/new-pictures/gutter-cleaning-new.jpg',
    category: 'outdoor',
    serviceType: 'roofing',
  },
  ...
  },
  {
    ...
    description: 'Complete boat detailing service. Choose interior, exterior, or full detail. Pricing based on boat length at $5.00 per foot. Boats over 40 ft require an estimate.',
    price: 'Starting at $75.00',
    priceCents: 7500,
    durationMinutes: 150,
  ...
  },
  {
    id: 'rv-detail',
    title: 'RV Detailing',
    description: 'Complete RV detailing service. Choose interior, exterior, or full detail. Pricing based on RV length at $6.00 per foot. Perfect for seasonal refresh.',
    price: 'Starting at $120.00',
    priceCents: 12000,
    durationMinutes: 180,
  ...
  // Add-ons & Products
  {
    ...
    priceCents: 1000,
    durationMinutes: 0,
    imageUrl: '/services/new-pictures/deodorizing-powder.jpg',
    category: 'addons',
