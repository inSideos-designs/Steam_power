...
export const SERVICES: Service[] = [
  // Indoor – Carpet Cleaning by room size
  {
    ...
    description: 'Perfect for nurseries, closets, and compact bedrooms. Includes spot treatment for high-use areas. Complimentary deodorizer and protection included.',
    price: '$40.00',
    priceCents: 4000,
    durationMinutes: 45,
  ...
  },
  {
    ...
    description: 'A thorough steam clean for bedrooms or small living areas to remove soil, allergens, and odors. Complimentary deodorizer and protection included.',
    price: '$60.00',
    priceCents: 6000,
    durationMinutes: 55,
  ...
  },
  {
    ...
    description: 'Ideal for standard living rooms or offices. Includes pretreating traffic lanes for a uniform finish. Complimentary deodorizer and protection included.',
    price: '$80.00',
    priceCents: 8000,
    durationMinutes: 70,
  ...
  },
  {
    ...
    description: 'Recommended for great rooms and gathering spaces. Restores color, lifts stains, and deodorizes. Complimentary deodorizer and protection included.',
    price: '$100.00',
    priceCents: 10000,
    durationMinutes: 90,
  ...
  },
  {
    ...
    sizeLabel: '200–299 sq ft',
    description: 'For larger kitchens or laundry rooms. Penetrates grout lines for a deep, lasting clean.',
    price: '$85.00',
    priceCents: 8500,
    durationMinutes: 80,
